...
<style scoped>section { font-size: 22px; line-height: 1.3; } li { margin: 0.1em 0; } .twocol { columns: 2; column-gap: 1.5em; font-size: 20px; margin-left: 1.5em; } .twocol li { break-inside: avoid; }</style>
